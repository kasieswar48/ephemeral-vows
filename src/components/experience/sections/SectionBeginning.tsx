    ...
    <section className="relative grid min-h-[100svh] place-items-center overflow-hidden px-6 py-32">
      ...
      <div className="relative z-10 mx-auto max-w-3xl text-center">
        ...
        <motion.h2
          ...
          className="font-display font-light text-foreground text-glow leading-[1.1] text-[2.2rem] sm:text-[3.8rem]"
        >
          Happiest Birthday,
          <br />
        ...
        <motion.div
          ...
          className="mx-auto my-12 h-px w-28 origin-center bg-gradient-to-r from-transparent via-foreground/30 to-transparent"
        />
        ...
        <motion.p
          ...
          className="mx-auto max-w-xl text-[15px] sm:text-base leading-[2] text-muted-foreground font-light"
        >
          Maybe we never had perfect timing.
          <br />
          Maybe life kept changing our paths.
          <br />
          But somehow,
          <br />
          <span className="text-foreground/85">my heart still kept finding you.</span>
        </motion.p>
      </div>
    </section>
  );
